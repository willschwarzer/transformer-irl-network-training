...
class SpaceInvadersBlockEnv(gym.Env):
    ...
    def __init__(self, block_rewards):
    ...
    def _init_obs(self):
        ...
        self.rgb_decode = np.empty(num_blocks+3, dtype=np.int32)
    ...
    def _take_action(self, action):
        ...
        if self.ships[0] != 0:
            ...
            if self.ships[0] == 1 or self.ships[0] == 2:
                ...
                #     pass
                reward += self.block_rewards[self.ships[0]-3]
            else:
...
#                     elif ship_block_type == BlockType.NEUTRAL:
#                         pass
                    # TODO add this back in once I figure out what it's supposed to be doing
                    # pos_mult = 
                    reward -= self.block_rewards[self.ships[ships_index]-3]
